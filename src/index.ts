import { VanJsfForm } from "./VanJsfForm";
import van from "vanjs-core";

const { div, p, h1 } = van.tags;
...
// App
const App = () => {
  const handleOnSubmit = (jsonValues: any) => {
    alert(`Submitted successfully: ${JSON.stringify(jsonValues, null, 2)}`);
